...
def predict(home_abbr, away_abbr):
    ...
    return {
        ...
        "model": "nfl-epa",
        "factors": {
            "home_off_epa": round(h["off_epa"], 3), "away_off_epa": round(a["off_epa"], 3),
            "home_def_epa": round(h["def_epa"], 3), "away_def_epa": round(a["def_epa"], 3),
            "home_net_epa": round(net_h, 3), "away_net_epa": round(net_a, 3),
            "home_edge": HOME_FIELD,
            "exp_margin": round(margin, 1), "avg_total": total,
        },
    }
