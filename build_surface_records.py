"""build_surface_records.py — surface W/L records -> surface_records.json"""
...
def main():
    ...
    print(f"[surf] exported {len(store):,} players -> {args.out}")
    if not store:
