...
_BARS = {
    "_pts": [
        (["pointsFor"], "Points / game", False, "pg"),
        (["pointsAgainst"], "Points allowed / game", True, "pg"),
        (["pointDifferential", "differential"], "Point differential", False, None),
        (["winPercent"], "Win %", False, "pct"),
    ],
    "_goals": [
        (["pointsFor"], "Goals / game", False, "pg"),
        (["pointsAgainst"], "Goals against / game", True, "pg"),
        (["pointDifferential", "differential"], "Goal differential", False, None),
        (["points"], "Points", False, None),
    ],
    "_runs": [
        (["pointsFor"], "Runs / game", False, "pg"),
        (["pointsAgainst"], "Runs allowed / game", True, "pg"),
