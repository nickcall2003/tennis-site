...
def stocks_movers(range: str = "1D"):
    """Best/worst movers from a curated universe (free-tier friendly)."""
    import stocks_engine as E
    import stocks_data as D
    universe = list(dict.fromkeys(E.STOCKS + E.ETFS + E.CRYPTO))  # reuse cached grid; free-tier friendly
    ...
    return {"gainers": gainers, "losers": losers, "disclaimer": E.DISCLAIMER}
